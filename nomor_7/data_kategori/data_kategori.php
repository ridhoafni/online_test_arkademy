...
<?php 
  ...
  include "../koneksi.php";
  $no = 0;
  $modal=mysqli_query($koneksi,"SELECT * FROM kategori ORDER BY id ASC");
        ...
        <div class="modal-body">
          <form action="proses_save.php" name="modal_popup" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group" style="padding-bottom: 10px;">
                  ...
                  <input type="text" name="name_category"  class="form-control" placeholder="Name" required/>
                </div>
